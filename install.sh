...
PLUGIN_PATH="${HOME}/.local/share/rhythmbox/plugins/apply_command/"
GLIB_SCHEME="org.gnome.rhythmbox.plugins.apply_command.gschema.xml"
...
sudo glib-compile-schemas "$GLIB_DIR" ; sudo chmod 644 /usr/share/glib-2.0/schemas/gschemas.compiled
